...
their expression, genomic context, evolutionary conservation, biogenesis and 
putative functions.
...
if (!requireNamespace(c("ggpubr", "ggplot2", "gridExtra"), quietly = TRUE))
...
- lenDownIntron: is the length (nt) of the intron immediately downstream the donor site 
in the selected transcript.
