...
```{r, echo=FALSE, out.width='40%', fig.align="center", fig.cap="\\label{fig:figs} Example of a project folder structure"}
...
targetsFTS_circ <-
getCircSeqs(annotatedCirc, gtf, bsGenome)
...
# Foreground target sequences
targetsFTS_bsj <-
    getSeqsAcrossBSJs(annotatedCirc, gtf, bsGenome)
...
## Module 14 - Annotate repetitive elements
