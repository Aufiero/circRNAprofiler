...
detection tool and the occurrences found in each sample. CircRNA that derived 
from the antisense strand are removed from the data frame and stored in a file 
