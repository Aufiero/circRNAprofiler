...
NOTE:
In this module circRNAs that derived from the antisense strand are identified. 
This subset of antisense circRNAs are removed from the data frame and stored 
in a file (antisenseCircRNAs.txt) for user consultation. A circRNA is defined 
antisense if the strand reported in the prediction results is different from
the strand reported in the genome annotation file. 
