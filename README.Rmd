...
[![HitCount](http://hits.dwyl.io/Aufiero/circRNAprofiler.svg)](http://hits.dwyl.io/Aufiero/circRNAprofiler) [![Build Status](https://travis-ci.org/{Aufiero}/{circRNAprofiler}.png?branch=master)](https://travis-ci.org/{Aufiero}/{circRNAprofiler})
